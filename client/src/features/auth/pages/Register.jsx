    ...
    <div className="flex flex-col items-center max-w-sm w-full p-6">
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-4">
        <div>
          <input
            ...
            className={`w-full px-4 py-2.5 bg-neutral-800/50 border ${errors.name ? 'border-red-500/50' : 'border-neutral-700/50'} rounded-md text-sm placeholder:text-neutral-500 focus:outline-none focus:border-neutral-500 transition-colors`}
          />
        ...
        >
          {isSubmitting ? <div className="spinner w-4 h-4" /> : "Sign up"}
        </button>
      </form>
      ...
      <div className="mt-8 flex flex-col items-center gap-2 text-xs text-neutral-400">
        <p>
          ...
          <button onClick={() => navigate('/login')} className="cursor-pointer text-white hover:underline">
            Log in
          </button>
        </p>
      </div>
